...
<tr style="border:0!important;">
	<td width="50%" valign="top" style="border:0!important;">
		...
		<h2>About Me</h2>
    <ul>
		  <li>Computer Science student passionate about technology and open-source.</li>
		  <li>I love exploring new retro aesthetics and terminal themes.</li>
		  <li>Learning JavaScript, Go & Linux scripting.</li>
    </ul>
		<h2>Knowledge</h2>
		<h3>Languages</h3>
		<div align="left">
			...
			<img width="12" />
			<img src="https://skillicons.dev/icons?i=react" height="40" alt="vue logo"  />
			<img width="12" />
